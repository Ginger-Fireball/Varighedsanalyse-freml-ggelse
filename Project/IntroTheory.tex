...
\begin{figure}[h]
    \centering
    \subfloat[age]{
    \includegraphics[width=0.32\linewidth]{Basses_kode/Billeder_duration/DFBetas_for_age.pdf}}\hfill
    \subfloat[ICI]{
    \includegraphics[width=0.32\linewidth]{Basses_kode/Billeder_duration/DFBetas_for_ici.pdf}}\hfill
     \subfloat[Epicell]{
    \includegraphics[width=0.32\linewidth]{Basses_kode/Billeder_duration/DFBetas_for_epicell.pdf}}\hfill
    \subfloat[Invas2]{\includegraphics[width=0.32\linewidth]{Basses_kode/Billeder_duration/DFBetas_for_invas2.pdf}}\hfill
    \subfloat[Sex]{\includegraphics[width=0.32\linewidth]{Basses_kode/Billeder_duration/DFBetas_for_sex.pdf}}\hfill\subfloat[Thickness]{\includegraphics[width=0.32\linewidth]{Basses_kode/Billeder_duration/DFBetas_for_thickness.pdf}}\hfill
    \subfloat[ulceration]{\includegraphics[width=0.32\linewidth]{Basses_kode/Billeder_duration/DFBetas_for_ulceration.pdf}}\hfill
